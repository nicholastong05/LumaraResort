        ...
        <div class="room-details-container">
            ...
            <div id="standard" class="room-detail-section">
                ...
                <div class="room-detail-content">
                    ...
                    <p class="room-description">
                        Experience comfort and elegance in our Standard Rooms. Perfect for couples or solo travelers,
                        these rooms offering a serene retreat with stunning views of the lush tropical gardens or the
            ...
            <div id="deluxe" class="room-detail-section reverse">
                ...
                <div class="room-detail-content">
                    <h2>Deluxe Room</h2>
                    <p class="room-description">
                        Elevate your stay in our Deluxe Rooms. Featuring direct beachfront access, a spacious layout,
            ...
            <div id="family" class="room-detail-section">
                ...
                <div class="room-detail-content">
                    <h2>Family Suite</h2>
                    <p class="room-description">
                        Your home away from home. The Family Suite is designed for ultimate comfort and bonding. With
